...
const DiaryPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const splitText = async () => {
      ...
      if (tit) {
        Splitting({target: tit})
        Splitting({target: txt})
        // titi = [Splitting({ target: tit })]
        var fx5Titles: HTMLElement[] = Array.from(
          document.querySelectorAll<HTMLElement>(
            ".content__title[data-effect5]",
          ),
        )
      }
      // console.log(fx5Titles);

      fx5Titles.forEach((title) => {
        gsap.fromTo(
          title.querySelectorAll("span.char"),
          {
      ...
      // fx5Titles.forEach((title) => {
      //   const chars = title.querySelectorAll("span.char")
      //   gsap.fromTo(
      //     chars,
      //     {
      ...
      var fx16Titles: HTMLElement[] = Array.from(
        document.querySelectorAll<HTMLElement>(
    ...
    const image = el.querySelector(".grid__item-img")
    ...
    <>
      ...
      <div id="Me" className=" p-20 rounded layout overflow-y-auto overflow-x-hidden h-auto w-full">
        <section>
          ...
          >
            <div className="grid">
              <div className="grid__item" id="it">
                <div
            ...
            <div>
              <div className="content" ref={titleRef}>
                <h2 id="intro" className="content__title" data-effect5>
                  <span id="intro" className="font-medium">
                    {/* <p id="firstP"  className="content__title" data-effect5> */}
                    In the grand tapestry of narratives that our world weaves,
                    there lies a studio baptized with my name by Oussama Ammar,
                    my esteemed co-founder. <br /> It beckons a tale of its own,
                    one that is mine to share.
                    {/* </p> */}
                  </span>
                </h2>
              </div>
            </div>
            <h1 id="h1">An Incredible Life</h1>
            <h2 id="h2">Lyra Haruto in her own words</h2>
          </div>
        ...
        <div className="content" ref={textRef}>
          ...
          >
            <p className="font-small">
              ...
              sights, a mélange of aromas – it was an orchestra without a
        ...
        <div className="content" ref={textRef}>
          ...
          >
            <p className="font-small">
              ...
              This studio, co-founded with Oussama, is more than an institution;
              it is a quest — a relentless search for the extraordinary, for
              those singular sparks of talent that illuminate the unexpected
              ...
              <br /> <br />
              The story of Oussama, my co-founder, and the remarkable team that
              constitutes The Lyra Haruto Company, is a testament to this
